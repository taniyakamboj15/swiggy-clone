...
const Header = () => {
  ...
  const {loggedInUser,name}=useContext(UserContext); //k
  console.log("my name",name);
  const cartItems =useSelector((store)=> store.cart.items);
  console.log(cartItems);
  return (
    <div className="flex justify-between items-center h-32 w-full bg-white px-40 shadow-lg shadow-gray-600 sticky top-0 z-10">
    <div className='w-56'>
    ...
    <div className=''> 
      ...
      <li className=' text-gray-400 hover:text-orange-500'> online Status:{onlineStatus? "❄" : "🩸"} </li>
        ...
        <li  className=' text-gray-400 hover:text-orange-500'>help</li>
        <li  className=' text-gray-400 hover:text-orange-500 font-bold '>
